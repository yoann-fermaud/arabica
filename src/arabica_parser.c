...
void no_args_instructions(FILE *p_arabicaOutput, char *p_line, int *p_filesize)
{
    ...
    if (strcmp(v_operation, "ADD") == 0)
        v_instructionVal = 0x04;
    else if (strcmp(v_operation, "SUB") == 0)
        v_instructionVal = 0x05;
    else if (strcmp(v_operation, "MUL") == 0)
        v_instructionVal = 0x06;
    else if (strcmp(v_operation, "DIV") == 0)
        v_instructionVal = 0x07;
    else if (strcmp(v_operation, "MOD") == 0)
        v_instructionVal = 0x08;
    else if (strcmp(v_operation, "EQ") == 0)
        v_instructionVal = 0x0C;
    else if (strcmp(v_operation, "NEQ") == 0)
        v_instructionVal = 0x0D;
    else if (strcmp(v_operation, "GT") == 0)
        v_instructionVal = 0x0E;
    else if (strcmp(v_operation, "LT") == 0)
        v_instructionVal = 0x0F;
    else if (strcmp(v_operation, "GTE") == 0)
        v_instructionVal = 0x10;
    else if (strcmp(v_operation, "LTE") == 0)
        v_instructionVal = 0x11;
    else if (strcmp(v_operation, "PRINT_VAL") == 0)
        v_instructionVal = 0x12;
    else if (strcmp(v_operation, "INPUT_VAL") == 0)
        v_instructionVal = 0x13;
    else if (strcmp(v_operation, "HALT") == 0)
        v_instructionVal = 0x14;
    else if (strcmp(v_operation, "PRINT_STR") == 0)
        v_instructionVal = 0x16;
    else if (strcmp(v_operation, "INPUT_STR") == 0)
        v_instructionVal = 0x17;
    else if (strcmp(v_operation, "STR_LEN") == 0)
        v_instructionVal = 0x18;
    else
        printf("Non-recognized instruction: %s\n", p_line);
